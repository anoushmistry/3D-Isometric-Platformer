Shader "Demo/Lit Stencil Reference Bird"
{
    Properties
    {
        ...
        [Space(30)][IntRange] _StencilRef ("Stencil Reference", Range(0, 255)) = 0
        [IntRange] _StencilComp("Stencil Comparison", Range(1, 8)) = 8 

        [Space(30)] _ShadowClipValue ("Shadow Clip Value", float) = 1000.0
    }
    ...
    SubShader
    {
        ...
        /* Custom shadow rendering pass so we can clip it at the door plane */
        Pass
        {
            Name "ShadowCaster"
            Tags
            ...
            {
                // Basically, just clip all the pixels that have passed through the void door.
                // I've kept it really simple here and just compare the world position x values
                clip(_ShadowClipValue - input.positionWS.x);
