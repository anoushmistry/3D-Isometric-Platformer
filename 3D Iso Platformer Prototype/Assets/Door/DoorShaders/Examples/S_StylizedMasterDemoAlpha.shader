Shader "Custom/S_StylizedMasterDemoAlpha"
{
    /*
    ...
    */
    ...
    Properties
    {
        ...
        [IntRange] _StencilOp("Stencil Op", Range(0, 7)) = 0


        [IntRange] _Cull("Culling", Range(0,2)) = 0
    }
        ...
        Pass
        {
            ...
            */
            ...
            float4 frag(Varyings input) : SV_Target
            {
                ...
                float4 unityColor = UniversalFragmentPBR(inputData, _Albedo * albedoSample, _Metallic, _Specular, _Smoothness, _Occlusion, _Emission * _EmissionIntensity, _Alpha);
